...
alias ll='l'
alias   k='eza -lgB --time-style=long-iso --group-directories-first -aT -L 1'
alias  kk='eza -lgB --time-style=long-iso --group-directories-first -aT -L 1 --total-size'
alias  kt='eza -lgB --time-style=long-iso --group-directories-first -aT'
alias kkt='eza -lgB --time-style=long-iso --group-directories-first -aT --total-size'

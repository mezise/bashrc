...
alias ll='l'
alias   k='eza -lgB --show-symlinks --time-style=long-iso --group-directories-first -aa'
alias  kk='eza -lgB --show-symlinks --time-style=long-iso --group-directories-first -aa --total-size'
alias  kt='eza -lgB --show-symlinks --time-style=long-iso --group-directories-first -T'
alias kkt='eza -lgB --show-symlinks --time-style=long-iso --group-directories-first -T --total-size'
...
alias updr='updr1'
alias upda='upda1'
alias updker='updker1'
##
alias pik1='pikaur'
alias pikrem1='pikaur -Rs'
alias piki1='pikaur -Si'
alias pikii1='pikaur -Qi'
alias pikf1='pacman -Ql'
alias upd1='pikaur -Syu'
alias updr1='pikaur -Syu -o'
alias upda1='pikaur -Syu -a'
alias updker1='pikaur -S $(pikaur -Qsq ^linux | grep -E --color=never ^linux)'
##
alias pik2='paru --upgrademenu --combinedupgrade'
alias pikrem2='paru --upgrademenu --combinedupgrade -Rs'
alias piki2='paru --upgrademenu --combinedupgrade -Si'
alias pikii2='paru --upgrademenu --combinedupgrade -Qi'
alias upd2='paru --upgrademenu --combinedupgrade -Syu'
alias updr2='paru --upgrademenu --combinedupgrade -Syu --repo'
alias upda2='paru --upgrademenu --combinedupgrade -Syu --aur'
alias updker2='paru -S $(paru -Qsq ^linux | grep -E --color=never ^linux)'
##
alias pik3='yay'
alias pikrem3='yay -Rs'
alias piki3='yay -Si'
alias pikii3='yay -Qi'
alias upd3='yay -Syu'
...
function _color_output_column {
	...
	vNC=$'\033[0m' # No Color
	sed -e "s|[[:space:]]*[^[:space:]]*|${vYEL}&${vNC}|${vCOL}"
	# awk "
   #      BEGIN {
   #          FPAT = \"([[:space:]]*[^[:space:]]+)\";
   #          OFS = \" \";

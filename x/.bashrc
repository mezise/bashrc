...
alias ll='l'
alias   k='eza -lgB --time-style=long-iso --group-directories-first -aa'
alias  kk='eza -lgB --time-style=long-iso --group-directories-first -aa --total-size'
alias  kt='eza -lgB --time-style=long-iso --group-directories-first -T'
alias kkt='eza -lgB --time-style=long-iso --group-directories-first -T --total-size'
